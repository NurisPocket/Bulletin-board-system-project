...
%>
    ...
    <div class="container">
		...
		<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="글 제목" name="boardTITLE" maxlength="50" value="<%= board.BoardTITLE()%>"></td>
					</tr>
					<tr>
						<td><textarea  class="form-control" placeholder="글 내용" name="boardCONTENT" maxlength="2048" style="height:350px"><%= board.BoardCONTENT()%></textarea></td>
					</tr>
				</tbody>
			</table>
