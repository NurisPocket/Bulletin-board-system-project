...
<body>
  ...
  <form action="login.do" method="post">
    ...
    <fieldset>
      ...
      <input type="text" name="userid" value="${userid }" required="required"  placeholder="아이디를 입력해 주세요">
      <label for="loginpw">비밀번호</label>
      <input type="password" name="pwd" required="required" placeholder="비밀번호를 입력해 주세요">
      <ul>
       
        <li><a href="#"  onclick="location.href='./index.jsp'">홈</a></li>
         <li><a href="#"  onclick="location.href='join.do'">회원가입</a></li>
      </ul>
      <!--데이터를 서버로 전송-->
